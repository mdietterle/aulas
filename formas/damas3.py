...
This is functionally almost the same as checkers_OOP.py, except that it's been almost completely refactored. 
The whole thing is much more structured and logical. I replaced a lot of the repeated code with loops or functions.
I've also added the ability for pieces to know what legal moves they have and prevent you from making others. You can also make mulitple
captures in one turn now.
...
class Graphics:
	def __init__(self):
		...
		self.background = pygame.image.load('C:\\Users\\Martim\\OneDrive\\Scripts Python\\formas\\board.png')
